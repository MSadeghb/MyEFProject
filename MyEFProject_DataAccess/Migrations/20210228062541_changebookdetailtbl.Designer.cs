...
namespace MyEFProject_DataAccess.Migrations
{
    ...
    [Migration("20210228062541_changebookdetailtbl")]
    partial class changebookdetailtbl
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyEFProject_Model.Models.Fluent_Book", b =>
                {
                    ...
                    b.HasOne("MyEFProject_Model.Models.Fluent_Publisher", "FluentPublisher")
            ...
            modelBuilder.Entity("MyEFProject_Model.Models.Fluent_BookAuthor", b =>
                {
                    b.HasOne("MyEFProject_Model.Models.Fluent_Author", "FluentAuthor")
                        .WithMany("FluentBookAuthors")
                        .HasForeignKey("Author_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyEFProject_Model.Models.Fluent_Book", "FluentBook")
                        .WithMany("FluentBookAuthors")
                        .HasForeignKey("Book_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
